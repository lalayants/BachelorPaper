...
% TODO:
% Sergei Shavetov, [4/24/25 7:38 AM]
% 21 слайд - добавить к названиям слово Алгоритм или Алгоритмы

% Sergei Shavetov, [4/24/25 7:39 AM]
% Пояснить конкретными примерами, где можно и нужно использовать

% Sergei Shavetov, [4/24/25 7:40 AM]
% 13 слайд - зачем именно микрокомпьютер? В постановке задачи об этом не было сказано. Может быть сервер или датпцентр подойдет?

% Sergei Shavetov, [4/24/25 7:41 AM]
% 11 слайд - пояснить, что такое IoU, ReID, и почему Kalman на фнглийском, хотя в русском есть всем понятное Фильтр Калмана

% DONE:
% Sergei Shavetov, [4/24/25 7:37 AM]
% 17 слайд - поянить что такое ReID

% Sergei Shavetov, [4/24/25 7:37 AM]
% 18 слайд - поянить что такое FPS